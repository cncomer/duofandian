...
//				}
	...
	private class Surface {
		...
		public int cellSelectedColor = Color.parseColor("#00B7EE");
		...
		public void init() {
			...
			weekendPaint.setColor(Color.parseColor("#00B7EE"));
			weekendPaint.setAntiAlias(true);
			float weekTextSize = weekHeight * 0.6f;
			weekendPaint.setTextSize(weekTextSize);
			weekendPaint.setTypeface(Typeface.DEFAULT_BOLD);
			...
			boxPath.rLineTo(width, 0);
			for (int i = 1; i < 7; i++) {
				boxPath.moveTo(0, monthHeight + weekHeight + i * cellHeight-1);
				boxPath.rLineTo(width, 0);
